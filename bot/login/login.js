...
let subTitle = `X69X BOT V2@${currentVersion} - Made by NTKhang  |  Updated by Azadx69x`;
const subTitleArray = [];
...
const author = ("Made by NTKhang  |  Updated by Azadx69x");
...
async function startBot(loginWithEmail) {
	...
	(function loginBot(appState) {
		...
		login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
			...
			log.info("BOT NICK NAME", global.GoatBot.config.nickNameBot || "X69X BOT V2");
			log.info("MAINTAINER", "Made by NTKhang  |  Updated by Azadx69x");
			...
			console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("Project X69X Bot v2 based on GoatBot v2 by NTKhang (https://github.com/ntkhang03), updated by Azadx69x. Please do not sell this source code or claim it as your own. Thank you!")}\x1b[0m`);
			logColor("#f5ab00", character);
